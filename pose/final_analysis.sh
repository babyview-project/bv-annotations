...
$PY pose_hand_camera.py --csv $ST/outputs/pose_1fps_bbox_limbs.csv --crosswalk meta/crosswalk_airtable_2026-07-24.tsv \
   --dims meta/frame_dims_2025_2.tsv --dims meta/frame_dims_2026_1_new.tsv --out analysis_2026_1 \
   --exclude_cameras headlight --fov bones=110 --fov mini=130 > analysis_2026_1.log 2>&1
...
$PY imu_camera_pitch.py analyze --imu imu/imu_video_pitch.tsv --crosswalk meta/crosswalk_airtable_2026-07-24.tsv \
   --out imu/analysis_2026_1 --pose_video_summary analysis_2026_1/video_summary.csv --exclude_cameras headlight --fov bones=110 --fov mini=130 > imu/analyze_2026_1.log 2>&1
